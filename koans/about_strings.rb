...
class AboutStrings < EdgeCase::Koan
  ...
  def test_use_flexible_quoting_to_handle_really_hard_cases
    ...
    b = %!flexible quotes can handle both ' and " characters! #NOTE: sweet~
...
EOS
  ...
  def test_plus_equals_also_will_leave_the_original_string_unmodified
    ...
    hi = original_string
    there = "World"
    hi += there # NOTE: means hi = hi + there
  ...
  def test_the_shovel_operator_modifies_the_original_string
    ...
    old_id = s.object_id
    s << ' new'
    # The content changed while the id didn't
    assert_equal old_id, s.object_id
    s += ''
    # The content didn't change but the id did, new string is constructed
    assert_not_equal old_id, s.object_id
  end
  ...
  def test_you_can_get_a_single_character_from_a_string
    string = "Bacon, lettuce and tomato"
    assert_equal ruby_version?('1.8') ? 97 : 'a', string[1]
