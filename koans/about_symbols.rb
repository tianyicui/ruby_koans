...
class AboutSymbols < EdgeCase::Koan
  ...
  # NOTE: this is the core difference between symbol and string
  ...
  in_ruby_version("mri") do
    def test_the_answer_of_question_above
      assert_equal true, Symbol.all_symbols.include?(:whatever_symbol_defined_here_are_in_the_list)
    end
  end

  # FIXME: jruby doesn't, but why?
  in_ruby_version("mri") do
